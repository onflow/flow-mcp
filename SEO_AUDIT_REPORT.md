# SEO/GEO Audit Report - flow-mcp

**Branch:** seo-geo-audit-2026-04-21
**Applied:** 2026-04-21
**Audit source:** audits/flow-mcp-audit-2026-04-20.md
...
- [ ] **Description:** `Model Context Protocol (MCP) server for the Flow network. Connect Claude, Cursor, and other AI assistants to Flow for agent-native development`
- [ ] **Topics (exact 12, comma-separated):** `flow, mcp, model-context-protocol, ai-agents, claude, cursor, ai-tools, typescript, developer-tools, web3, agent-infrastructure, ai-native`
...
- Description: `Model Context Protocol (MCP) server for the Flow network. Connect Claude, Cursor, and other AI assistants to Flow for agent-native development`
- Topics (12): `flow, mcp, model-context-protocol, ai-agents, claude, cursor, ai-tools, typescript, developer-tools, web3, agent-infrastructure, ai-native`
- Homepage URL: `https://flow.com`
- Enable Discussions: Settings -> General -> Features

## Audit source
`audits/flow-mcp-audit-2026-04-20.md`
```
